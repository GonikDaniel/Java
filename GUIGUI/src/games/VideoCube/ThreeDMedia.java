...
/**
 * Created by Daniel_Gonik on 17.08.15.
 */
...
public class ThreeDMedia extends Application {
    ...
    private static final String MEDIA_URL =
            "http://igonik.ru/video/OnTopOfTheWorld.mp4";

    private static final int SCENE_W = 1240;
    private static final int SCENE_H = 800;

    private static final double MEDIA_W = 940 * 2/3;
    private static final double MEDIA_H = 509 * 2/3;
